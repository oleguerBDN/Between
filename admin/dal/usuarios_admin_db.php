...
$borrar = mysql_query("DELETE FROM usuarios_admin WHERE id='$id'", $conn); 
...
$insertar = mysql_query("INSERT INTO usuarios_admin (username, password) values ('$username', '$password')", $conn);
