                ...
                <div id="sidebar-left" class="span1">
                    <div class="nav-collapse sidebar-nav">
                        <ul class="nav nav-tabs nav-stacked main-menu">
                            ...
                            <li class="active"><a href="categoriasm.php"><i class="fa-icon-hdd"></i><span class="hidden-tablet">Categorías<br/>Mujer</span></a></li>
                    ...
                    <div class="row-fluid" >
                        ...
                        <?php if (!isset($_GET["id"])) {?>
                                ...
                                <fieldset>
                                    <!-- Form Name -->
                                    <tr>
                                        <legend>Categorías Mujer</legend>

                                    <!-- Button -->
                                    <form action="<?php echo BASE_URL . "admin/dal/cat_mujer_db.php"?>" method="post">
                                        <table>
					  ...
					  <th>Categoría</th>
                                    ...
                                    $id = $row["id"];
                                    echo "<td align='center'><a class='btn btn-info' href='" . BASE_URL . "admin/categoriasm.php?id=$id" . "'> <i class='halflings-icon edit halflings-icon'></i></a></td>";
                                    echo "<td align='center'><a class='btn btn-danger' href='" . BASE_URL . "admin/dal/cat_mujer_db.php?id=$id" . "'> <i class='halflings-icon trash halflings-icon'></i></a></td></tr>";
                           ...
                           <?php } elseif (isset($_GET["id"])) { 
                               ...
                               $id=$_GET["id"];
                               $query = "SELECT nombre FROM cat_mujer WHERE id='$id' ";
                               $result = mysql_query($query);
                               $numero = 0; 
