                ...
                <div id="content" class="span11">
                    ...
                    <div class="row-fluid" >
                        <div class="box span10">
                           ...
                           <?php if (!isset($_GET["id"])) {?>
                                <fieldset>
                                    ...
                                    <!-- Button -->
                                    <form enctype="multipart/form-data" action="<?php echo BASE_URL . "admin/dal/pro_mujer_db.php"?>" method="post">
                                        <table>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <select name="id_cat">
                                                          ...
                                                          <?php
                                                            $query = "SELECT id, nombre FROM cat_mujer ";
                                   ...
                                   <div class=" span11">
                                       <fieldset>
                                           <legend>Lista Productos Mujer</legend> 
					  ...
					  <th>Modelo</th>
                                    ...
                                    <tbody>
                                    <?php 
                                    $query = "SELECT id, id_cat, modelo, color, tallas, precio_cost, pvp, descripcion, imagen FROM pro_mujer ";
                                    $result = mysql_query($query);
                                    $numero = 0; 
                                    ...
                                    $id = $row["id"];
                                    $id_cat = $row["id_cat"];
                                    $res = mysql_query("SELECT nombre FROM cat_mujer WHERE id='$id_cat'", $conn);
                                    ...
                                    echo "<td align='center'><a class='btn btn-info' href='" . BASE_URL . "admin/productosm.php?id=$id" . "'> <i class='halflings-icon edit halflings-icon'></i></a></td>";
                                    echo "<td align='center'><a class='btn btn-success' href='" . BASE_URL . "admin/img.php?id=$id&s=m" . "'> <i class='halflings-icon camera halflings-icon'></i></a></td>";
                                    echo "<td align='center'><a class='btn btn-danger' href='" . BASE_URL . "admin/dal/pro_mujer_db.php?id=$id" . "'> <i class='halflings-icon trash halflings-icon'></i></a></td></tr>";
...
<!--ESTA ES LA PARTE PARA EDITAR UN FORMULARIO (SOLO SE MUESTRA SI SE PASA UNA ID POR GET) -->
                            ...
                            <?php } elseif (isset($_GET["id"])) { ?>
                                    ...
                                    $id = $_GET["id"];
                                    $query = "SELECT id, id_cat, modelo, color, tallas, precio_cost, pvp, descripcion, imagen FROM pro_mujer WHERE id='$id' ";
                                    $result = mysql_query($query);
                                    $numero = 0; 
