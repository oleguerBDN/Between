...
//<form encrypt="multipart">
//$_FILES -->name, tmp_name, error
...
//    echo '$to'.$to."<br/>"; 
//    echo '$from'.$from."<br/>";
//    echo '$subject_mail'.$subject_mail."<br/>";
//    echo '$html'.$html."<br/>";
//    echo '$text'.$text."<br/>"; 
    ...
    try {
        ...
        $php_mailer->Host = HOST_EMAIL;
        $php_mailer->Username = ACCOUNT_EMAIL;
        $php_mailer->Password = PASSWORD_EMAIL;
        $php_mailer->From = ACCOUNT_EMAIL;
